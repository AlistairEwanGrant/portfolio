<x-app-layout>
    ...
    <div class="p-24 max-sm:p-6 bg-cyan-900 text-white">
        ...
        <a href="{{route('curriculumVitae.index')}}" class="btn btn-light w-full inline-block" id="cv" target="_blank">
            <div
                class=" mx-auto border-green-100 rounded bg-white text-black mt-5 w-full text-center px-6 pt-2.5 pb-2 text-xs font-medium uppercase leading-normal w-max text-white shadow-[0_4px_9px_-4px_#3b71ca] transition duration-150 ease-in-out hover:bg-primary-600 hover:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] focus:bg-primary-600 focus:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] focus:outline-none focus:ring-0 active:bg-primary-700 active:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)]">
                Click to
