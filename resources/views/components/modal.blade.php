                ...
                <div class="max-w-lg w-full px-3 mx-auto">
                    <div class="justify-center flex flex-wrap">
                        <div class="shrink-0 w-2/3 w-full px-3">
                            ...
                            <p class="mb-3">
                                This is a blog created using Laravel. It demonstrates a CRUD application working with
                                authentication.
                                Feel free to create a user and share a post
                                or read the posts as a guest by clicking on Blog in the nav bar. Posts can be created,
                                updated and deleted.
                                All posts are displayed in a list on the post index page.
                            </p>
