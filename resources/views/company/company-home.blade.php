...
{{--            integrity="sha256-oP6HI9z1XaZNBrJURtCoUT5SUnxFr8s3BzRl+cbzUq8=" crossorigin="anonymous"></script>--}}
    ...
    @vite(['resources/css/bootstrapFive.css', 'resources/js/company.js'])
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content centered-page-content">
                <div class="modal-header">
                    ...
                    <select class="btn btn-primary dropdown-toggle dropdownTableAdd" type="button" id="dropdownTableAdd"
                    ...
                    <select class="btn btn-primary dropdown-toggle dropdownTableEdit" type="button"
                            id="dropdownTableEdit" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <option value="personnel">Personnel</option>
                        <option value="department">Department</option>
                        <option value="location">Location</option>
                    </select>
                ...
                <div class="modal-body centered-page-content">
                    ...
                    <form id="firstModalPage">
                        ...
                        <div class="form-group">
                            ...
                            <select class="btn btn-secondary dropdown-toggle dropdownMenuDepartment" type="button"
                                    id="dropdownDepartmentsEdit" data-toggle="dropdown" aria-haspopup="true"
                                    aria-expanded="false">
                    ...
                    <form id="newDepartmentForm">
                        ...
                        <div class="form-group">
                            ...
                            <select class="btn btn-secondary dropdown-toggle dropdownMenuDepartment" type="button"
                                    id="newDepartmentLocation" data-toggle="dropdown" aria-haspopup="true"
                                    aria-expanded="false">
                            </select>
                        </div>
                        </br>
                    ...
                    <form id="editDepartmentForm">
                        ...
                        <div class="form-group">
                            ...
                            <select class="btn btn-secondary dropdown-toggle dropdownMenuDepartment" type="button"
                                    id="editDepartment" data-toggle="dropdown" aria-haspopup="true"
                                    aria-expanded="false">
                            </select>
                        </div>
                        </br>
                    ...
                    <form id="editLocationForm">
                        ...
                        <div class="form-group">
                            ...
                            <select class="btn btn-secondary dropdown-toggle dropdownMenuDepartment" type="button"
                                    id="editLocation" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            </select>
                        </div>
                        </br>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" id="trashButtonPersonnel" class="btn btn-primary"><i class="fas fa-trash-alt"
                                                                                               id='trash'></i></button>
                    <button type="button" id="trashButtonDepartment" class="btn btn-primary"><i class="fas fa-trash-alt"
                                                                                                id='trash'></i></button>
                    <button type="button" id="trashButtonLocation" class="btn btn-primary"><i class="fas fa-trash-alt"
                                                                                              id='trash'></i></button>
    ...
    <nav class="navbar-mine navbar-expand-lg navbar-light bg-light border-bottom">
        <div id="resize">
            ...
            <input type="search" id="myInput" placeholder=" Search for names.." title="Type in a name"
                   class="form-control rounded" aria-label="Search"
                   aria-describedby="search-addon"/>

            <select class="btn btn-secondary dropdown-toggle dropdownMenuDepartment bold-text-name" type="button"
                    id="dropdownDepartments" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <option value="0" id="0">Department</option>
            </select>

            <select class="btn btn-secondary dropdown-toggle dropdownMenuButton bold-text-name" type="button"
                    id="dropdownLocation" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <option value="0" id="0">Location</option>
            </select>

            <button type="button" class="btn btn-outline-dark btn-secondary white" id="addNew"><i class="fas fa-plus"
                                                                                                  style="color:white"></i>
            </button>
